...
function findEvenNumber(numbers) {
  ...
  // Незалежно від результату, виводимо вихідний масив.
    ...
    catch(error){   console.log(numbers, error.toString())  }
...
try {
   if (!user) {
       ...
       console.log( error.message.toString(), error.cause = user);
